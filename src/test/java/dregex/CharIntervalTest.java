...
class CharIntervalTest {
    ...
    void testNonOverlapping() {
        ...
        var expected = Map.of(
                ...
                new CharRange(21, 30), List.of(new CharInterval(21, 25), new CharInterval(26, 30)),
                new CharRange(0, 100),
                        List.of(
                ...
                new CharRange(9, 9), List.of(new CharInterval(9, 9)),
                new CharRange(10, 11), List.of(new CharInterval(10, 10), new CharInterval(11, 11)),
                new CharRange(9, 10), List.of(new CharInterval(9, 9), new CharInterval(10, 10)),
                new CharRange(10, 12),
                        List.of(new CharInterval(10, 10), new CharInterval(11, 11), new CharInterval(12, 12)),
                new CharRange(17, 25), List.of(new CharInterval(17, 20), new CharInterval(21, 25)));
