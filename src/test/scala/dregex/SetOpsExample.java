...
class SetOpsExample {
    ...
    public static void main(String[] args) {
        {
            List<CompiledRegex> regexes = Regex$.MODULE$.compile(Arrays.asList("[a-z]+", "[A-Z]+", "[a-z]+|[A-Z]+"));
            // In Scala 2.12
        ...
        {
            List<CompiledRegex> regexes = Regex$.MODULE$.compile(Arrays.asList("[a-z]+|[A-Z]+", "[A-Z]+"));
            // In Scala 2.12
